...
const abi: ContractInterface = [{
  ...
  "anonymous": false,
  "inputs": [{"indexed": true, "internalType": "address", "name": "contributor", "type": "address"}, {
    "indexed": false,
    "internalType": "uint256",
    "name": "newSpeed",
    "type": "uint256"
...
export const ComptrollerContract = (address: string, provider: Signer | providers.Provider) =>
